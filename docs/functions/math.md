...
| `ceiling(x: float): float`<br />`ceiling(x: numeric): numeric`<br /><br /> Nearest integer greater than or equal to argument. |
| `degrees(rad: integer): float`<br />`degrees(rad: float): float`<br /><br /> Converts radians to degrees. |
| `floor(x: float): float`<br />`floor(x: numeric): numeric`<br /><br /> Nearest integer less than or equal to argument. |
...
| `power(a: integer, b: integer): float`<br />`power(a: float, b: float): float`<br />`power(a: integer, b: float): float`<br />`power(a: float, b: integer): float`<br /><br /> a raised to the power of b. |
