...
- 6) Input
    ...
    - 6.7) [LTSV](input/ltsv.md)
    - 6.8) [RAW](input/raw.md)
    - 6.9) [RegEx](input/regex.md)
    - 6.10) [STDIN](input/stdin.md)
    - 6.11) [Text](input/text-line.md)
    - 6.12) [TSV](input/tsv.md)
    - 6.13) [XML](input/xml.md)
- 7) Output
