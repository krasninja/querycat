...
namespace QueryCat.Plugins.Sdk
{
  ...
  public partial class Column : TBase
  {
    ...
    {
      var tmp90 = new StringBuilder("Column(");
      int tmp91 = 0;
      if(__isset.@id)
      {
      ...
      if((Description != null) && __isset.@description)
      {
        tmp90.Append(", Description: ");
        Description.ToString(tmp90);
      }
      tmp90.Append(')');
