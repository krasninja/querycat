...
public partial class QueryCatParser : Parser {
	...
	public const int
		...
		CONCAT=26, LESS_LESS=27, GREATER_GREATER=28, TYPECAST=29, ANY=30, BOOL=31, 
		BOOLEAN=32, DECIMAL=33, FLOAT=34, INT=35, INT8=36, INTEGER=37, NUMERIC=38, 
		OBJECT=39, REAL=40, STRING=41, TEXT=42, TIMESTAMP=43, AND=44, AS=45, AT=46, 
		BY=47, CAST=48, DEFAULT=49, ELSE=50, END=51, EXISTS=52, FALSE=53, FROM=54, 
		IF=55, IN=56, IS=57, LIKE=58, LIKE_REGEX=59, NOT=60, NULL=61, ON=62, ONLY=63, 
		OR=64, SOME=65, THEN=66, TO=67, TRUE=68, USING=69, VOID=70, TRIM=71, LEADING=72, 
		TRAILING=73, BOTH=74, CURRENT_DATE=75, CURRENT_TIMESTAMP=76, INTERVAL=77, 
		YEAR=78, DOY=79, DAYOFYEAR=80, MONTH=81, DOW=82, WEEKDAY=83, DAY=84, HOUR=85, 
		MINUTE=86, SECOND=87, MILLISECOND=88, LOCAL=89, TIME=90, ZONE=91, CASE=92, 
		COALESCE=93, EXTRACT=94, POSITION=95, WHEN=96, OCCURRENCES_REGEX=97, SUBSTRING_REGEX=98, 
		POSITION_REGEX=99, TRANSLATE_REGEX=100, ECHO=101, ALL=102, ASC=103, BETWEEN=104, 
		CURRENT=105, DESC=106, DISTINCT=107, EXCEPT=108, FETCH=109, FIRST=110, 
		FOLLOWING=111, FORMAT=112, FULL=113, GROUP=114, HAVING=115, INNER=116, 
		INTERSECT=117, INTO=118, JOIN=119, LAST=120, LEFT=121, LIMIT=122, NEXT=123, 
		NULLS=124, OFFSET=125, ORDER=126, OUTER=127, OVER=128, PARTITION=129, 
		PRECEDING=130, RECURSIVE=131, RIGHT=132, ROW=133, ROWS=134, SELECT=135, 
		SIMILAR=136, TOP=137, UNBOUNDED=138, UNION=139, VALUES=140, WHERE=141, 
		WINDOW=142, WITH=143, UPDATE=144, INSERT=145, DECLARE=146, SET=147, TYPE=148, 
		IDENTIFIER=149, INTEGER_LITERAL=150, FLOAT_LITERAL=151, NUMERIC_LITERAL=152, 
		STRING_LITERAL=153, BOOLEAN_LITERAL=154, SINGLE_LINE_COMMENT=155, MULTILINE_COMMENT=156, 
		SPACES=157;
	public const int
	...
	private static readonly string[] _LiteralNames = {
		...
		"'?'", "'['", "']'", "'[]'", "'&>'", "'+'", "'-'", "'*'", "'/'", "'%'", 
		"'='", "'<>'", "'>'", "'>='", "'<'", "'<='", "'||'", "'<<'", "'>>'", "'::'", 
		"'ANY'", "'BOOL'", "'BOOLEAN'", "'DECIMAL'", "'FLOAT'", "'INT'", "'INT8'", 
		"'INTEGER'", "'NUMERIC'", "'OBJECT'", "'REAL'", "'STRING'", "'TEXT'", 
		"'TIMESTAMP'", "'AND'", "'AS'", "'AT'", "'BY'", "'CAST'", "'DEFAULT'", 
	...
	private static readonly string[] _SymbolicNames = {
		...
		"CONCAT", "LESS_LESS", "GREATER_GREATER", "TYPECAST", "ANY", "BOOL", "BOOLEAN", 
		"DECIMAL", "FLOAT", "INT", "INT8", "INTEGER", "NUMERIC", "OBJECT", "REAL", 
		"STRING", "TEXT", "TIMESTAMP", "AND", "AS", "AT", "BY", "CAST", "DEFAULT", 
		"ELSE", "END", "EXISTS", "FALSE", "FROM", "IF", "IN", "IS", "LIKE", "LIKE_REGEX", 
		"NOT", "NULL", "ON", "ONLY", "OR", "SOME", "THEN", "TO", "TRUE", "USING", 
		...
		"WITH", "UPDATE", "INSERT", "DECLARE", "SET", "TYPE", "IDENTIFIER", "INTEGER_LITERAL", 
	...
	public FunctionArgContext functionArg() {
		...
		try {
			...
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 562949954469896L) != 0)) {
				{
				State = 201;
				_la = TokenStream.LA(1);
				if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 562949954469896L) != 0)) ) {
	...
	public FunctionCallContext functionCall() {
		...
		try {
			...
			case 1:
				...
				ErrorHandler.Sync(this);
				_la = TokenStream.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 3472627156423639042L) != 0) || ((((_la - 68)) & ~0x3f) == 0 && ((1L << (_la - 68)) & 8304722825L) != 0) || ((((_la - 149)) & ~0x3f) == 0 && ((1L << (_la - 149)) & 63L) != 0)) {
					{
					State = 207;
					functionCallArg();
					State = 212;
	...
	public SelectTableJoinedContext selectTableJoined() {
		...
		try {
			...
			case 1:
				...
				ErrorHandler.Sync(this);
				_la = TokenStream.LA(1);
				if (((((_la - 113)) & ~0x3f) == 0 && ((1L << (_la - 113)) & 524553L) != 0)) {
					{
					State = 539;
					selectJoinType();
					}
	...
	public SelectJoinTypeContext selectJoinType() {
		...
		try {
			...
			case RIGHT:
				...
				State = 567;
				_la = TokenStream.LA(1);
				if ( !(((((_la - 113)) & ~0x3f) == 0 && ((1L << (_la - 113)) & 524545L) != 0)) ) {
				ErrorHandler.RecoverInline(this);
				}
				else {
					ErrorHandler.ReportMatch(this);
	...
	public CaseExpressionContext caseExpression() {
		...
		try {
			...
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2315202052189421570L) != 0) || ((((_la - 68)) & ~0x3f) == 0 && ((1L << (_la - 68)) & 8304722825L) != 0) || ((((_la - 149)) & ~0x3f) == 0 && ((1L << (_la - 149)) & 63L) != 0)) {
				{
				State = 758;
	...
	public DateTimeFieldContext dateTimeField() {
		...
		try {
			...
			State = 852;
			_la = TokenStream.LA(1);
			if ( !(((((_la - 78)) & ~0x3f) == 0 && ((1L << (_la - 78)) & 2047L) != 0)) ) {
			ErrorHandler.RecoverInline(this);
			}
			else {
				ErrorHandler.ReportMatch(this);
	...
	public TypeContext type() {
		...
		try {
			...
			State = 854;
			_la = TokenStream.LA(1);
			if ( !(((((_la - 30)) & ~0x3f) == 0 && ((1L << (_la - 30)) & 141836999999487L) != 0)) ) {
			ErrorHandler.RecoverInline(this);
			}
			else {
				ErrorHandler.ReportMatch(this);
	...
	private static int[] _serializedATN = {
		4,1,157,1008,2,0,7,0,2,1,7,1,2,2,7,2,2,3,7,3,2,4,7,4,2,5,7,5,2,6,7,6,2,
		...
		130,0,18,3,0,3,3,20,20,49,49,2,0,103,103,106,106,2,0,149,149,153,153,2,
		0,102,102,107,107,2,0,108,108,139,139,3,0,113,113,121,121,132,132,1,0,
		133,134,2,0,109,109,122,122,2,0,110,110,123,123,1,0,63,63,1,0,72,74,1,
		0,78,88,3,0,30,43,70,70,77,77,1,0,15,16,1,0,20,25,3,0,30,30,65,65,102,
		102,1,0,27,28,1,0,17,19,1133,0,135,1,0,0,0,2,162,1,0,0,0,4,164,1,0,0,0,
		6,183,1,0,0,0,8,190,1,0,0,0,10,222,1,0,0,0,12,226,1,0,0,0,14,230,1,0,0,
		0,16,237,1,0,0,0,18,242,1,0,0,0,20,244,1,0,0,0,22,254,1,0,0,0,24,265,1,
		0,0,0,26,315,1,0,0,0,28,317,1,0,0,0,30,342,1,0,0,0,32,374,1,0,0,0,34,376,
		1,0,0,0,36,387,1,0,0,0,38,389,1,0,0,0,40,402,1,0,0,0,42,414,1,0,0,0,44,
		426,1,0,0,0,46,448,1,0,0,0,48,450,1,0,0,0,50,455,1,0,0,0,52,465,1,0,0,
		0,54,474,1,0,0,0,56,481,1,0,0,0,58,492,1,0,0,0,60,537,1,0,0,0,62,564,1,
		0,0,0,64,571,1,0,0,0,66,573,1,0,0,0,68,583,1,0,0,0,70,586,1,0,0,0,72,589,
		1,0,0,0,74,601,1,0,0,0,76,611,1,0,0,0,78,621,1,0,0,0,80,630,1,0,0,0,82,
		634,1,0,0,0,84,639,1,0,0,0,86,650,1,0,0,0,88,653,1,0,0,0,90,656,1,0,0,
		0,92,680,1,0,0,0,94,682,1,0,0,0,96,686,1,0,0,0,98,701,1,0,0,0,100,703,
		1,0,0,0,102,716,1,0,0,0,104,718,1,0,0,0,106,727,1,0,0,0,108,729,1,0,0,
		0,110,740,1,0,0,0,112,743,1,0,0,0,114,750,1,0,0,0,116,757,1,0,0,0,118,
		773,1,0,0,0,120,850,1,0,0,0,122,852,1,0,0,0,124,854,1,0,0,0,126,887,1,
		0,0,0,128,974,1,0,0,0,130,1005,1,0,0,0,132,134,5,9,0,0,133,132,1,0,0,0,
		134,137,1,0,0,0,135,133,1,0,0,0,135,136,1,0,0,0,136,138,1,0,0,0,137,135,
		1,0,0,0,138,143,3,2,1,0,139,140,5,9,0,0,140,142,3,2,1,0,141,139,1,0,0,
		0,142,145,1,0,0,0,143,141,1,0,0,0,143,144,1,0,0,0,144,149,1,0,0,0,145,
		143,1,0,0,0,146,148,5,9,0,0,147,146,1,0,0,0,148,151,1,0,0,0,149,147,1,
		0,0,0,149,150,1,0,0,0,150,152,1,0,0,0,151,149,1,0,0,0,152,153,5,0,0,1,
		153,1,1,0,0,0,154,163,3,10,5,0,155,163,3,18,9,0,156,163,3,90,45,0,157,
		...
		0,163,3,1,0,0,0,164,165,5,149,0,0,165,174,5,1,0,0,166,171,3,8,4,0,167,
		...
		1,182,5,1,0,0,0,183,187,3,124,62,0,184,185,5,24,0,0,185,186,5,149,0,0,
		186,188,5,22,0,0,187,184,1,0,0,0,187,188,1,0,0,0,188,7,1,0,0,0,189,191,
		5,8,0,0,190,189,1,0,0,0,190,191,1,0,0,0,191,192,1,0,0,0,192,194,5,149,
		...
		0,203,204,1,0,0,0,204,9,1,0,0,0,205,206,5,149,0,0,206,215,5,1,0,0,207,
		...
		219,5,149,0,0,219,220,5,1,0,0,220,221,5,17,0,0,221,223,5,2,0,0,222,205,
		1,0,0,0,222,218,1,0,0,0,223,11,1,0,0,0,224,225,5,149,0,0,225,227,5,4,0,
		0,226,224,1,0,0,0,226,227,1,0,0,0,227,228,1,0,0,0,228,229,3,126,63,0,229,
		13,1,0,0,0,230,231,5,146,0,0,231,232,5,149,0,0,232,235,3,124,62,0,233,
		234,5,3,0,0,234,236,3,2,1,0,235,233,1,0,0,0,235,236,1,0,0,0,236,15,1,0,
		0,0,237,238,5,147,0,0,238,239,5,149,0,0,239,240,5,3,0,0,240,241,3,2,1,
		0,241,17,1,0,0,0,242,243,3,26,13,0,243,19,1,0,0,0,244,245,5,126,0,0,245,
		246,5,47,0,0,246,251,3,22,11,0,247,248,5,6,0,0,248,250,3,22,11,0,249,247,
		...
		257,1,0,0,0,257,262,1,0,0,0,258,259,5,124,0,0,259,263,5,110,0,0,260,261,
		5,124,0,0,261,263,5,120,0,0,262,258,1,0,0,0,262,260,1,0,0,0,262,263,1,
		0,0,0,263,23,1,0,0,0,264,266,5,45,0,0,265,264,1,0,0,0,265,266,1,0,0,0,
		266,267,1,0,0,0,267,268,7,2,0,0,268,25,1,0,0,0,269,271,3,40,20,0,270,269,
		1,0,0,0,270,271,1,0,0,0,271,272,1,0,0,0,272,274,5,135,0,0,273,275,3,86,
		...
		1,0,0,0,320,321,10,2,0,0,321,323,5,117,0,0,322,324,7,3,0,0,323,322,1,0,
		...
		0,345,344,1,0,0,0,345,346,1,0,0,0,346,347,1,0,0,0,347,349,5,135,0,0,348,
		...
		375,1,0,0,0,362,363,5,135,0,0,363,368,3,46,23,0,364,365,5,6,0,0,365,367,
		...
		381,1,0,0,0,384,388,5,102,0,0,385,388,5,107,0,0,386,388,3,38,19,0,387,
		384,1,0,0,0,387,385,1,0,0,0,387,386,1,0,0,0,388,37,1,0,0,0,389,390,5,107,
		0,0,390,391,5,62,0,0,391,392,5,1,0,0,392,397,3,128,64,0,393,394,5,6,0,
		0,394,396,3,128,64,0,395,393,1,0,0,0,396,399,1,0,0,0,397,395,1,0,0,0,397,
		398,1,0,0,0,398,400,1,0,0,0,399,397,1,0,0,0,400,401,5,2,0,0,401,39,1,0,
		0,0,402,404,5,143,0,0,403,405,5,131,0,0,404,403,1,0,0,0,404,405,1,0,0,
		...
		1,0,0,0,413,411,1,0,0,0,414,419,5,149,0,0,415,416,5,1,0,0,416,417,3,44,
		22,0,417,418,5,2,0,0,418,420,1,0,0,0,419,415,1,0,0,0,419,420,1,0,0,0,420,
		421,1,0,0,0,421,422,5,45,0,0,422,423,5,1,0,0,423,424,3,26,13,0,424,425,
		...
		128,0,0,437,440,5,149,0,0,438,440,3,72,36,0,439,437,1,0,0,0,439,438,1,
		...
		1,0,0,0,449,47,1,0,0,0,450,453,5,118,0,0,451,454,3,10,5,0,452,454,5,153,
		...
		34,0,463,462,1,0,0,0,463,464,1,0,0,0,464,51,1,0,0,0,465,466,5,54,0,0,466,
		...
		487,1,0,0,0,490,491,5,2,0,0,491,57,1,0,0,0,492,493,5,140,0,0,493,498,3,
		...
		0,0,508,538,1,0,0,0,509,512,5,153,0,0,510,511,5,112,0,0,511,513,3,10,5,
		...
		0,0,522,538,1,0,0,0,523,526,5,149,0,0,524,525,5,112,0,0,525,527,3,10,5,
		...
		32,0,540,539,1,0,0,0,540,541,1,0,0,0,541,542,1,0,0,0,542,543,5,119,0,0,
		543,544,3,60,30,0,544,545,5,62,0,0,545,546,3,126,63,0,546,565,1,0,0,0,
		547,549,3,64,32,0,548,547,1,0,0,0,548,549,1,0,0,0,549,550,1,0,0,0,550,
		551,5,119,0,0,551,552,3,60,30,0,552,553,5,69,0,0,553,554,5,1,0,0,554,559,
		5,149,0,0,555,556,5,6,0,0,556,558,5,149,0,0,557,555,1,0,0,0,558,561,1,
		...
		1,0,0,0,566,572,5,116,0,0,567,569,7,5,0,0,568,570,5,127,0,0,569,568,1,
		0,0,0,569,570,1,0,0,0,570,572,1,0,0,0,571,566,1,0,0,0,571,567,1,0,0,0,
		572,65,1,0,0,0,573,574,5,114,0,0,574,575,5,47,0,0,575,580,3,126,63,0,576,
		577,5,6,0,0,577,579,3,126,63,0,578,576,1,0,0,0,579,582,1,0,0,0,580,578,
		1,0,0,0,580,581,1,0,0,0,581,67,1,0,0,0,582,580,1,0,0,0,583,584,5,115,0,
		0,584,585,3,126,63,0,585,69,1,0,0,0,586,587,5,141,0,0,587,588,3,126,63,
		0,588,71,1,0,0,0,589,591,5,1,0,0,590,592,5,149,0,0,591,590,1,0,0,0,591,
		...
		0,0,598,599,1,0,0,0,599,600,5,2,0,0,600,73,1,0,0,0,601,602,5,129,0,0,602,
		603,5,47,0,0,603,608,3,126,63,0,604,605,5,6,0,0,605,607,3,126,63,0,606,
		604,1,0,0,0,607,610,1,0,0,0,608,606,1,0,0,0,608,609,1,0,0,0,609,75,1,0,
		0,0,610,608,1,0,0,0,611,612,5,126,0,0,612,613,5,47,0,0,613,618,3,22,11,
		0,614,615,5,6,0,0,615,617,3,22,11,0,616,614,1,0,0,0,617,620,1,0,0,0,618,
		616,1,0,0,0,618,619,1,0,0,0,619,77,1,0,0,0,620,618,1,0,0,0,621,622,5,142,
		...
		1,0,0,0,630,631,5,149,0,0,631,632,5,45,0,0,632,633,3,72,36,0,633,81,1,
		0,0,0,634,635,5,125,0,0,635,637,3,126,63,0,636,638,7,6,0,0,637,636,1,0,
		...
		0,648,647,1,0,0,0,648,649,1,0,0,0,649,85,1,0,0,0,650,651,5,137,0,0,651,
		652,5,150,0,0,652,87,1,0,0,0,653,654,5,122,0,0,654,655,3,126,63,0,655,
		89,1,0,0,0,656,657,5,144,0,0,657,658,3,92,46,0,658,659,5,147,0,0,659,664,
		...
		0,0,674,677,5,153,0,0,675,676,5,112,0,0,676,678,3,10,5,0,677,675,1,0,0,
		...
		5,20,0,0,684,685,3,126,63,0,685,95,1,0,0,0,686,687,5,145,0,0,687,688,5,
		118,0,0,688,690,3,98,49,0,689,691,3,100,50,0,690,689,1,0,0,0,690,691,1,
		0,0,0,691,692,1,0,0,0,692,693,3,102,51,0,693,97,1,0,0,0,694,702,3,10,5,
		0,695,698,5,153,0,0,696,697,5,112,0,0,697,699,3,10,5,0,698,696,1,0,0,0,
		...
		1,0,0,0,716,715,1,0,0,0,717,103,1,0,0,0,718,719,5,101,0,0,719,720,3,126,
		63,0,720,105,1,0,0,0,721,722,5,149,0,0,722,724,5,7,0,0,723,725,5,149,0,
		0,724,723,1,0,0,0,724,725,1,0,0,0,725,728,1,0,0,0,726,728,5,149,0,0,727,
		...
		738,739,5,2,0,0,739,109,1,0,0,0,740,741,5,77,0,0,741,742,5,153,0,0,742,
		111,1,0,0,0,743,744,5,48,0,0,744,745,5,1,0,0,745,746,3,128,64,0,746,747,
		5,45,0,0,747,748,3,124,62,0,748,749,5,2,0,0,749,113,1,0,0,0,750,755,5,
		46,0,0,751,756,5,89,0,0,752,753,5,90,0,0,753,754,5,91,0,0,754,756,3,128,
		64,0,755,751,1,0,0,0,755,752,1,0,0,0,756,115,1,0,0,0,757,759,5,92,0,0,
		...
		1,0,0,0,765,769,1,0,0,0,766,764,1,0,0,0,767,768,5,50,0,0,768,770,3,126,
		63,0,769,767,1,0,0,0,769,770,1,0,0,0,770,771,1,0,0,0,771,772,5,51,0,0,
		772,117,1,0,0,0,773,774,5,96,0,0,774,775,3,126,63,0,775,776,5,66,0,0,776,
		777,3,126,63,0,777,119,1,0,0,0,778,851,5,75,0,0,779,851,5,76,0,0,780,781,
		5,71,0,0,781,783,5,1,0,0,782,784,7,10,0,0,783,782,1,0,0,0,783,784,1,0,
		0,0,784,786,1,0,0,0,785,787,5,153,0,0,786,785,1,0,0,0,786,787,1,0,0,0,
		787,789,1,0,0,0,788,790,5,54,0,0,789,788,1,0,0,0,789,790,1,0,0,0,790,791,
		1,0,0,0,791,792,3,128,64,0,792,793,5,2,0,0,793,851,1,0,0,0,794,795,5,95,
		0,0,795,796,5,1,0,0,796,797,5,153,0,0,797,798,5,56,0,0,798,799,3,128,64,
		0,799,800,5,2,0,0,800,851,1,0,0,0,801,802,5,94,0,0,802,803,5,1,0,0,803,
		804,3,122,61,0,804,805,5,54,0,0,805,806,3,128,64,0,806,807,5,2,0,0,807,
		851,1,0,0,0,808,809,5,93,0,0,809,810,5,1,0,0,810,815,3,126,63,0,811,812,
		...
		851,1,0,0,0,820,821,5,97,0,0,821,822,5,1,0,0,822,823,5,153,0,0,823,824,
		5,56,0,0,824,825,3,128,64,0,825,826,5,2,0,0,826,851,1,0,0,0,827,828,5,
		98,0,0,828,829,5,1,0,0,829,830,5,153,0,0,830,831,5,56,0,0,831,832,3,128,
		64,0,832,833,5,2,0,0,833,851,1,0,0,0,834,835,5,99,0,0,835,836,5,1,0,0,
		836,837,5,153,0,0,837,838,5,56,0,0,838,839,3,128,64,0,839,840,5,2,0,0,
		840,851,1,0,0,0,841,842,5,100,0,0,842,843,5,1,0,0,843,844,5,153,0,0,844,
		845,5,56,0,0,845,846,3,128,64,0,846,847,5,143,0,0,847,848,5,153,0,0,848,
		...
		16,873,874,5,52,0,0,874,875,5,1,0,0,875,876,3,26,13,0,876,877,5,2,0,0,
		...
		5,60,0,0,886,888,3,126,63,1,887,856,1,0,0,0,887,858,1,0,0,0,887,859,1,
		...
		3,126,63,13,904,906,10,11,0,0,905,907,5,60,0,0,906,905,1,0,0,0,906,907,
		1,0,0,0,907,908,1,0,0,0,908,909,5,58,0,0,909,956,3,126,63,12,910,912,10,
		10,0,0,911,913,5,60,0,0,912,911,1,0,0,0,912,913,1,0,0,0,913,914,1,0,0,
		0,914,915,5,136,0,0,915,916,5,67,0,0,916,956,3,126,63,11,917,919,10,7,
		0,0,918,920,5,60,0,0,919,918,1,0,0,0,919,920,1,0,0,0,920,921,1,0,0,0,921,
		922,5,104,0,0,922,923,3,128,64,0,923,924,5,44,0,0,924,925,3,126,63,8,925,
		956,1,0,0,0,926,927,10,4,0,0,927,928,5,44,0,0,928,956,3,126,63,5,929,930,
		10,3,0,0,930,931,5,64,0,0,931,956,3,126,63,4,932,933,10,25,0,0,933,956,
		3,114,57,0,934,935,10,17,0,0,935,936,5,29,0,0,936,956,3,124,62,0,937,939,
		10,9,0,0,938,940,5,60,0,0,939,938,1,0,0,0,939,940,1,0,0,0,940,941,1,0,
		0,0,941,942,5,56,0,0,942,956,3,108,54,0,943,945,10,8,0,0,944,946,5,60,
		0,0,945,944,1,0,0,0,945,946,1,0,0,0,946,947,1,0,0,0,947,948,5,56,0,0,948,
		956,3,26,13,0,949,950,10,2,0,0,950,952,5,57,0,0,951,953,5,60,0,0,952,951,
		1,0,0,0,952,953,1,0,0,0,953,954,1,0,0,0,954,956,5,61,0,0,955,889,1,0,0,
		...
		0,0,0,996,1006,5,150,0,0,997,1006,5,151,0,0,998,1006,5,152,0,0,999,1006,
		5,154,0,0,1000,1006,5,153,0,0,1001,1006,5,68,0,0,1002,1006,5,53,0,0,1003,
		1006,5,61,0,0,1004,1006,3,110,55,0,1005,996,1,0,0,0,1005,997,1,0,0,0,1005,
