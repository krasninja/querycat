...
public sealed class ClassRowsIterator<TClass> : IRowsIterator
{
    ...
    public ClassRowsIterator(Column[] columns, Func<TClass, VariantValue>[] valuesGetters, IEnumerable<TClass> enumerable)
    {
